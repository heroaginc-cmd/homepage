    ...
    <main style={{ paddingTop: "64px" }}>
      <section style={{ backgroundColor: "#F9F9F9", padding: "96px 24px" }}>
        <div style={{ maxWidth: "72rem", margin: "0 auto" }}>
          ...
          <a
            href="#services"
            style={{ display: "inline-block", backgroundColor: "#1A1A1A", color: "#ffffff", padding: "16px 32px", fontSize: "0.875rem", letterSpacing: "0.05em", textDecoration: "none" }}
          >
            サービスを見る
          </a>
        </div>
      ...
      <section id="services" style={{ backgroundColor: "#ffffff", padding: "96px 24px" }}>
        <div style={{ maxWidth: "72rem", margin: "0 auto" }}>
          ...
          <div className={styles.ctaButtons} style={{ marginTop: "64px" }}>
            <Link
              ...
              style={{ backgroundColor: "#F18E24", color: "#ffffff", padding: "16px 32px", fontSize: "0.875rem", letterSpacing: "0.05em", textDecoration: "none", textAlign: "center", display: "inline-block" }}
            >
              AI台本生成を無料体験
            </Link>
            <a
              ...
              style={{ border: "1px solid #1A1A1A", color: "#1A1A1A", padding: "16px 32px", fontSize: "0.875rem", letterSpacing: "0.05em", textDecoration: "none", textAlign: "center", display: "inline-block" }}
            >
              LINEで相談する
            </a>
          </div>
