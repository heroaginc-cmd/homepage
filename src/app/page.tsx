    ...
    <main className="pt-16">
      <section className="bg-[#F9F9F9] px-6 py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <a href="#services" className="inline-block bg-[#1A1A1A] text-white px-8 py-4 text-sm tracking-wider hover:bg-[#404040] transition-colors">
            サービスを見る
          </a>
        </div>
      </section>
      ...
      <section id="services" className="bg-white px-6 py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-16">
            <Link href="/drama-generator" className="bg-[#F18E24] text-white px-8 py-4 text-sm tracking-wider hover:bg-[#D4780F] transition-colors text-center">
              AI台本生成を無料体験
            </Link>
            <a href="https://lin.ee/vBEfQwi" target="_blank" rel="noopener noreferrer" className="border border-[#1A1A1A] text-[#1A1A1A] px-8 py-4 text-sm tracking-wider hover:bg-[#1A1A1A] hover:text-white transition-colors text-center">
              LINEで相談する
            </a>
          </div>
        </div>
